...
const WorkerMode = ({ sheetId, db, darkMode, language = 'it' }) => {
    ...
    React.useEffect(() => {
        if (canvasRef.current) {
            initCanvas(canvasRef.current, darkMode);
        }
    }, [darkMode]);
    ...
    if (error) {
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className={`${cardClass} p-8 rounded-lg shadow-xl text-center`}>
        ...
        return (
            <div className={`min-h-screen ${bgClass} p-4`}>
                <div className="max-w-2xl mx-auto">
                    <div className={`${cardClass} rounded-xl shadow-lg p-6 mt-4`}>
                        <div className="text-center mb-6">
                            <h1 className="text-2xl font-bold mb-1 text-indigo-700 dark:text-indigo-400">
            ...
            <div className="max-w-2xl mx-auto">
                <div className={`${cardClass} rounded-xl shadow-lg p-6 mt-4`}>
                    <div className="text-center mb-6">
                        ...
                        <p className={`${textClass} text-lg`}>{t.registerHours}</p>
                        
                        {sheetData && (
                            <div className="mt-4">
                                <p className="font-semibold text-lg">{sheetData.titoloAzienda}</p>
                                <p className={textClass}>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className={`p-4 rounded-lg ${darkMode ? 'bg-indigo-900/30' : 'bg-indigo-50'}`}>
                            <p className={`font-semibold text-lg ${darkMode ? 'text-indigo-300' : 'text-indigo-700'}`}>
                        ...
                        <button
                            ...
                            className={`w-full py-2 px-4 rounded-lg border ${darkMode ? 'border-gray-600 hover:bg-gray-700' : 'border-gray-300 hover:bg-gray-50'} transition-colors`}
                        >
                        ...
                        <div>
                            ...
                            <canvas
                                ...
                                width={400}
                                height={150}
                                className={`w-full ${darkMode ? 'dark-mode' : ''}`}
                            />
                            <button
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full py-4 bg-indigo-600 text-white rounded-lg font-bold text-lg hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors touch-button"
                        >
