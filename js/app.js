...
function showMorePage() {
    ...
    // Crea o mostra la pagina "Altro"
    let morePage = document.getElementById('morePage');
    if (!morePage) {
        morePage = document.createElement('div');
        morePage.id = 'morePage';
        morePage.className = 'section more-page active';
        morePage.innerHTML = `
            <h2>⚙️ Altro</h2>
            <div class="more-grid">
                <div class="more-item" onclick="showSection('settings')">
                    <span class="icon">⚙️</span>
                    <span class="label">Impostazioni</span>
                </div>
                <div class="more-item" onclick="showSection('blacklist')">
                    <span class="icon">🚫</span>
                    <span class="label">Blacklist</span>
                </div>
                <div class="more-item" onclick="showSection('auditLog')">
                    <span class="icon">📋</span>
                    <span class="label">Audit Log</span>
                </div>
                <div class="more-item" onclick="showSection('notifications')">
                    <span class="icon">🔔</span>
                    <span class="label">Notifiche</span>
                </div>
                <div class="more-item" onclick="showBackupRestore()">
                    <span class="icon">💾</span>
        ...
        `;
        document.querySelector('.container')?.appendChild(morePage);
    } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const buttons = document.querySelectorAll('.btn, .nav-item, .bottom-nav-item');
