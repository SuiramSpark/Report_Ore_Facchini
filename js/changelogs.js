    ...
    en: [
        {
            ...
            changes: [
                '🌟 NEW: Improvements to the scheduled notifications system',
    ...
    es: [
        {
            ...
            changes: [
                '🌟 NEW: Mejoras en el sistema de notificaciones programadas',
                '📊 NEW: Estadísticas avanzadas para trabajadores',
                '🔒 FIX: Optimizaciones de seguridad para la copia de seguridad y restauración',
                '🌐 IMPROVED: Traducciones actualizadas en todos los idiomas soportados'
            ]
        },
        {
            version: 'v4.2',
            ...
            changes: [
                ...
                '📱 NEW: Notificacions Android completamente funcionales (PWA con Service Worker)',
    ...
    fr: [
        {
            ...
            changes: [
                '🌟 NEW: Améliorations du système de notifications programmées',
                '📊 NEW: Statistiques avancées pour les travailleurs',
                '🔒 FIX: Optimisations de sécurité pour la sauvegarde et la restauration',
                '🌐 IMPROVED: Traductions mises à jour dans toutes les langues supportées'
            ]
        },
        {
            version: 'v4.2',
    ...
    ro: [
        {
            ...
            changes: [
                '🌟 NEW: Îmbunătățiri ale sistemului de notificări programate',
                '📊 NEW: Statistici avansate pentru muncitori',
                '🔒 FIX: Optimizări de securitate pentru backup și restaurare',
                '🌐 IMPROVED: Traduceri actualizate în toate limbile suportate'
            ]
        },
        {
            version: 'v4.2',
